...
Those two lines were the **only** output the application produced across 5,834 lines of
logcat for that capture, which is the privacy half of the design observed rather than
reasoned about.
