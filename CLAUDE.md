...
| **The Inbox opens and triages** | **Half done, 4 Sep 2026.** The tray read *1 waiting in the Inbox*, the entry opened the window, the row stated its reason — *"No date was found in this capture"* — and offered the chips without a press. **Assign a date** and **save** both done. **Still owed: edit, snooze and discard**, and each surviving a close-and-reopen. | any Inbox row |
...
| **FR-704 does not nag** | **Half done, 4 Sep 2026**: the count appeared as *1 waiting in the Inbox* and nothing louder — no badge, no notification. **Still owed: that it is absent at zero rather than "0 waiting", and that a snoozed row is not counted.** | empty Inbox, then one snoozed row |
