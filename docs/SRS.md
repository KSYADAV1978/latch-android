...
author: "Version 1.43 (draft for developer handover)"
date: "28 August 2026"
---
...
| Version | 1.43 — draft for developer handover |
...
>
> Three other requirements remain unmet, because the UI each needs is not built. **FR-506 row 3**: a capture with a time but no date cannot be saved at all, because completing it needs the date picker that row describes. **FR-507**'s Event/Task override is likewise absent, so the parser's classification stands. **FR-510**'s past-date follow-up is not offered; a past date is saved as read.
>
