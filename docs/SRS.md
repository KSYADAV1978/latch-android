...
author: "Version 1.17 (draft for developer handover)"
date: "28 August 2026"
---
...
| Version | 1.17 — draft for developer handover |
...
The date compared is the **resolved** date — what the parser produced after applying `ParseContext.now` — not the text that produced it. "5 March 2030" and "next Tuesday" resolving to the same day are the same date for this purpose.
