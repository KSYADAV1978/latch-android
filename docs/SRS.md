...
author: "Version 1.41 (draft for developer handover)"
date: "28 August 2026"
---
...
| Version | 1.41 — draft for developer handover |
...
>
> **Two improvements are owed to the document case and are deliberately not in this slice.** **Page-level progress**: NFR-102's spinner says only that something is happening, where a document can say "Reading page N of M…" — the information exists at the point the loop runs and is simply not surfaced. And **skipping the second recogniser** for a document whose first page shows no Devanagari, which would remove roughly half the per-page cost; it is a heuristic about a whole document taken from one page, so it is to be **measured before it is adopted**, like every other decision in this section.
